                    ...
                    <div class="rover-widget-body">
                        ...
                        <div class="col-xs-6">
                            <ul class="list-unstyled section-links">
                                ...
                                <li>
                                    <a href="update-sitter.php" data-qa-id="account-widgets-account-info-update">Update</a>
                                </li>
...
<a href="calander.php">Calendar</a>
            ...
            <div class="col-md-3">
                <div class="rover-widget-block">
                    <div class="rover-widget-block-inner-wide">
                        <h5 class="rover-widget-title bordered-bottom">
                            <i class="rover-icon rover-icon-stay-photos"></i>
                            Sitter Profile
                        </h5>
                        <div class="rover-widget-body">
                            <div class="col-xs-12">
...
<a href="update-sitter.php">Details</a>
